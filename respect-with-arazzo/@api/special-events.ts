...
export default async function listSpecialEventsHandler(
  request: Request,
  context: ApiFunctionsContext
) {
  try {
    // Hardcoded special events data matching the OpenAPI examples
    const specialEvents = [
      {
        ...
        eventDescription:
          "They're big, they're hairy, but they're also graceful. Come learn how the biggest feet can have the lightest touch.",
      ...
      },
      {
        ...
        eventDescription:
          'See leading parrot minds discuss important geopolitical issues.',
      ...
      },
      {
        ...
        location: 'Cafeteria',
        eventDescription:
          'We accidentally bought too much corn. Please come eat it.',
        dates: ['2023-11-10', '2023-11-17', '2023-11-24'],
        price: 5,
      },
    ];
    ...
    // In a real implementation, you would filter by dates and paginate
    return context.status(200).json(specialEvents);
  } catch (error) {
